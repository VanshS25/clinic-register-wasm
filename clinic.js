...
var _register_patient = Module['_register_patient'] = makeInvalidEarlyAccess('_register_patient');
var _add_visit = Module['_add_visit'] = makeInvalidEarlyAccess('_add_visit');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['register_patient'] != 'undefined', 'missing Wasm export: register_patient');
  assert(typeof wasmExports['add_visit'] != 'undefined', 'missing Wasm export: add_visit');
  ...
  _register_patient = Module['_register_patient'] = createExportWrapper('register_patient', 4);
  _add_visit = Module['_add_visit'] = createExportWrapper('add_visit', 4);
